   ...
   return {
      autoanimations: {
        ...
        primary: {
          ...
          sound: { enable: false, delay: 0, volume: 0.75 },
          options: {
            contrast: 0, delay: 0, elevation: 1000, isWait: false,
            opacity: 1, playbackRate: 1, repeat: 1, repeatDelay: 250,
        ...
        secondary: {
            ...
            sound: { enable: false },
            options: { opacity: 1, size: 1, elevation: 1000 }
        },
        source: {
            enable: false,
            video: { dbSection: "static", menuType: "spell", animation: "curewounds", variant: "01", color: "blue"},
